...
void InputHandler::handleAllEvents() {
    ...
    while (dequeueEvent(eventToHandle)) {
        ...
        case EInputEventType::MouseMove: {
            auto& window = Platforms::Win32::GameWindowHandler::getInstance();
...
bool InputHandler::registerForMouseEvent(MouseInput::EMouseInputType event, InputEventSig callBack) {
